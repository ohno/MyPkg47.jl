...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://ohno.github.io/MyPkg47.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://ohno.github.io/MyPkg47.jl/dev/)
...
[![License](https://img.shields.io/github/license/ohno/MyPkg47.jl)](LICENSE)
...
```julia
import Pkg; Pkg.add(url="https://github.com/ohno/MyPkg47.jl.git")
```
...
Feature requests and bug reports are handled via GitHub [Issues](https://github.com/ohno/MyPkg47.jl/issues).
...
[CITATION.bib](https://github.com/ohno/MyPkg47.jl/blob/main/CITATION.bib) is available for citing this package.
...
This package is released under the [MIT License](https://github.com/ohno/MyPkg47.jl/blob/main/LICENSE).
